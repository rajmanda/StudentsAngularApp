...
# docker build -t dockerrajmanda/students-angular-app:latest ./   {builds the docker image}
...
# docker tag dockerrajmanda/students-angular-app:latest  dockerrajmanda/students-angular-app:latest
